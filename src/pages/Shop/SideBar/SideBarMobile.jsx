import { Drawer, Slider, theme } from 'antd'
                        ...
                        <div key={category._id}>
                            ...
                            >
                                <div className="flex items-center justify-between w-full text-sm font-normal">
                                    <span
                                        className={`text-gray-700 cursor-pointer  ${openSections[category.name] ? 'font-extrabold' : ''} transition-all duration-300 ease-in-out`}
